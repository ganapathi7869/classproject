...
SECRET_KEY = '@dh*l69k9gpvbf)y0$00+4w==*j@u_we+9kp)d^4u6r^@0tni4'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],           # if the app has templates with folder name other than 'templates',then, we should include that path here
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
